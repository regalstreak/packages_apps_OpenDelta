...
JNIEXPORT jint JNICALL Java_com.resurrection.ota_Native_zipadjust(JNIEnv * env, jobject clazz, jstring jFilenameIn, jstring jFilenameOut, jint decompress) {
...
JNIEXPORT jint JNICALL Java_com.resurrection.ota_Native_dedelta(JNIEnv * env, jobject clazz, jstring jFilenameSource, jstring jFilenameDelta, jstring jFilenameOut) {
